...
namespace MyFirstMVC.Migrations
{
    ...
    [Migration("20180924134819_AddCompanies")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFirstMVC.Models.CompanyModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyFirstMVC.Models.Phone", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CategoryId = 1, CompanyId = 1, Name = "Iphone 4", Price = 200.0 },
                        new { Id = 2, CategoryId = 2, CompanyId = 2, Name = "Xperia", Price = 100.0 }
                    );
                });
            ...
            modelBuilder.Entity("MyFirstMVC.Models.Phone", b =>
                {
                    ...
                    b.HasOne("MyFirstMVC.Models.CompanyModel", "Company")
                        .WithMany("Phones")
